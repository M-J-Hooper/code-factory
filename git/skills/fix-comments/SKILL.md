...
user-invocable: true
allowed-tools: Bash(git:*), Bash(gh:*), Bash(${CLAUDE_PLUGIN_ROOT}/skills/fix-comments/scripts/*), Read, Write, Edit, Grep, Glob, AskUserQuestion
---
...
```bash
${CLAUDE_PLUGIN_ROOT}/skills/fix-comments/scripts/get-pr-comments.sh -a {number}
```

For comment URLs, pass the full URL instead of the PR number:

```bash
${CLAUDE_PLUGIN_ROOT}/skills/fix-comments/scripts/get-pr-comments.sh -a "https://github.com/org/repo/pull/42#discussion_r123"
```
